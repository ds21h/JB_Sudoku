...
class SudokuGameSave {
    ...
    SudokuGameSave(SudokuGameSave pGame){

    }

    SudokuGameSave(List<PlayField> pFields, boolean pSetUp, boolean pLib, int pDifficulty, int pSelectedField, int pUsedTime) {
        mPlayFields = pFields;
